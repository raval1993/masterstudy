...
define('SERVICE_URL', 'https://microservices.stylemixthemes.com/changelog/');
define('GITBOOK_ACCESSES_TRANSIENT', 'gitbook_accesses_transient');

define( 'STM_PREMIUM_PLUGINS', 'https://stylemixthemes.com/plugins/' );
define( 'STM_PREMIUM_THEMES', 'https://stylemixthemes.com/themes/' );
define( 'STM_CUSTOMIZATION', 'https://stylemix.net/ticket-form/?utm_source=stylemix_web&utm_medium=main_menu&utm_campaign=customization/' );
