		...
		<?php if ( !$activated ) { ?>
            <div class="stm-admin-box stm-admin-not-activated">
                <div class="__top">
                    ...
                    <a href="<?php echo esc_url( STM_INSTRUCTIONS_URL ) ?>" target="_blank">How to activate the
                        theme?</a>
                </div>
                <div class="__activate_row">
                    <a href="<?php echo esc_url( STM_Theme_Info::get_activation_url() ) ?>" class="stm-button"><i
                                class="stmadmin-icon-envato"></i>Activate via Envato</a>
                    <div class="__info">
                        <i class="stmadmin-icon-info-filled"></i>
                        You need to activate your theme license to choose layout and import demo content.
                    </div>
                </div>
            </div>
		<?php } else { ?>
            <div class="stm-admin-box stm-admin-activated">
                <div class="__top">
                    ...
                    <a href="<?php echo esc_url( GENERATE_TOKEN ); ?>" target="_blank">How to activate the theme?</a>
                </div>
                <div class="__code_row">
                    ...
                    <a class="new-license" href="<?php echo esc_url( STM_BUY_ANOTHER_LICENSE ); ?>" target="_blank">Buy
                        new License</a>
                </div>
            </div>
		<?php } ?>
